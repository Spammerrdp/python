...
def squat():
    ...
    <table border="9" >
        <tr><td><input type="submit" name="sub" style="color:#1a2421;background-color:#cbcbcb;font-size: 20px;text-align:center;height:40px;width:90px" value="Squats"></td></tr>
    </table>
        </form>"""
