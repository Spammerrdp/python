...
Travis Johnson
760-555-7147
749 Washington St., BraavosSD 25668
...
# Below r"" or r'' stands for raw string
data=re.compile(r'[a-zA-Z0-9]+@[a-zA-Z0-9]+.[a-zA-Z0-9]+')
dt=data.finditer(my_list)
#In below line i used for loop because if we will not use for loop then it will display - <callable_iterator object at 0x0000013005D53C10>
for i12 in dt:
    print(i12)